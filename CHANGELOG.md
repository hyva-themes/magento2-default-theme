...
[Unreleased]: https://gitlab.hyva.io/hyva-themes/magento2-default-theme/-/compare/1.4.10...main
...
This release contains no changes - it is to keep the theme version in sync with the theme-module.
