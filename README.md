...
* **Copyright:** This product includes software developed by Magento, Inc. (https://github.com/magento/magento2) and distributed under the Open Source License (OSL) v3.0.  
